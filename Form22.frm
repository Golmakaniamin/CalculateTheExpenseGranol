...
Do
  If Form9.Adodc1.Recordset.Fields!Name = "«‰»«— „Õ’Ê·" Then
...
Do
  If Form10.Adodc1.Recordset.Fields!Name = "«‰»«— „Õ’Ê·" Then
...
Do
  If Form11.Adodc1.Recordset.Fields!Name = "«‰»«— „Õ’Ê·" Then
...
Do
  If Form13.Adodc1.Recordset.Fields!Name = "«‰»«— „Õ’Ê·" Then
...
Form15.Adodc3.RecordSource = "SELECT * FROM ozanmasir WHERE name= '«‰»«— „Õ’Ê·' "
...
If Form15.Adodc3.Recordset.RecordCount > 0 Then
  ...
  Do
    ...
    Adodc3.RecordSource = "select * from AnbarMahsol WHERE (idmahsol=" + Trim(Str(Form15.Adodc3.Recordset.Fields!idmahsol)) + ") and (rad=" + Trim(Str(Form15.Adodc3.Recordset.Fields!rad)) + ")"
    Adodc3.Refresh
    ...
    If Adodc4.Recordset.RecordCount > 0 Then
      Adodc4.Recordset.Find "name= '«‰»«— „Õ’Ê·'"
...
Adodc3.ConnectionString = Form3.Text10.Text
Adodc3.CommandType = adCmdUnknown
Adodc3.RecordSource = "select * from AnbarMahsol ORDER BY rad ASC"
Adodc3.Refresh
