...
Do
  If Form9.Adodc1.Recordset.Fields!Name = "œ—«„  ÊÌ” —" Then
...
Do
  If Form10.Adodc1.Recordset.Fields!Name = "œ—«„  ÊÌ” —" Then
...
Do
  If Form11.Adodc1.Recordset.Fields!Name = "œ—«„  ÊÌ” —" Then
...
Do
  If Form13.Adodc1.Recordset.Fields!Name = "œ—«„  ÊÌ” —" Then
...
Form15.Adodc3.RecordSource = "SELECT * FROM ozanmasir WHERE name= 'œ—«„  ÊÌ” —' "
...
If Form15.Adodc3.Recordset.RecordCount > 0 Then
  ...
  Do
    ...
    Adodc3.RecordSource = "select * from DramToester WHERE (idmahsol=" + Trim(Str(Form15.Adodc3.Recordset.Fields!idmahsol)) + ") and (rad=" + Trim(Str(Form15.Adodc3.Recordset.Fields!rad)) + ")"
    Adodc3.Refresh
    ...
    If Adodc4.Recordset.RecordCount > 0 Then
      Adodc4.Recordset.Find "name= 'œ—«„  ÊÌ” —'"
...
Adodc3.ConnectionString = Form3.Text10.Text
Adodc3.CommandType = adCmdUnknown
Adodc3.RecordSource = "select * from DramToester ORDER BY rad ASC"
Adodc3.Refresh
