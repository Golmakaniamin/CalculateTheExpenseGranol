...
Begin VB.Form Form1 
   ...
   Caption         =   "ãÕÑÝ ãÞÏÇÑí ãæÇÏ ÏÑ ÊæáíÏ ÑÇäæá ÏæÑå 5"
   ClientHeight    =   6285
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9675
...
If Adodc1.Recordset.RecordCount > 0 Then
  ...
  Do
    ...
    Adodc2.RecordSource = "select sum(meghdar) as meghdar1 from g_ozanunder where (idmahsol=" + Trim(Str(Adodc1.Recordset.Fields!idmavad)) + ")"
    Adodc2.Refresh
    w = Adodc2.Recordset.Fields!meghdar1

    Adodc2.ConnectionString = Form3.Text10.Text
    Adodc2.CommandType = adCmdUnknown
    Adodc2.RecordSource = "select sum(j5) as meghdar1 from g_ozanunder where (idmahsol=" + Trim(Str(Adodc1.Recordset.Fields!idmavad)) + ")"
    Adodc2.Refresh
    e = Adodc2.Recordset.Fields!meghdar1
    ...
    If Adodc2.Recordset.RecordCount > 0 Then
      ...
      Do
        ...
        Form7.Adodc1.RecordSource = "Select * From g_gardeshmavad Where (nomade=2) and (idmade=" + Trim(Str(Adodc2.Recordset.Fields!idmahsol)) + ")"
        Form7.Adodc1.Refresh
        If Form7.Adodc1.Recordset.RecordCount > 0 Then
          q = Form7.Adodc1.Recordset.Fields!kharidteydoremeghdar
          If w <> 0 Then
            Adodc2.Recordset.Fields!j5 = (q / w) * Adodc2.Recordset.Fields!meghdar
          Else
        ...
        Form7.Adodc1.Refresh
        If Form7.Adodc1.Recordset.RecordCount > 0 Then
          q = Form7.Adodc1.Recordset.Fields!masrafteydoremeghdar
        Else
          q = 0
        End If
        
        If w <> 0 Then
          Adodc2.Recordset.Fields!j51 = (q / w) * Adodc2.Recordset.Fields!meghdar
        Else
          Adodc2.Recordset.Fields!j51 = 0
        End If
