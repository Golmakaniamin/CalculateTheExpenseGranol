...
Do
  If Form9.Adodc1.Recordset.Fields!Name = "«” —‰œ— 36 + 1" Then
...
Do
  If Form10.Adodc1.Recordset.Fields!Name = "«” —‰œ— 36 + 1" Then
...
Do
  If Form11.Adodc1.Recordset.Fields!Name = "«” —‰œ— 36 + 1" Then
...
Do
  If Form13.Adodc1.Recordset.Fields!Name = "«” —‰œ— 36 + 1" Then
...
Form15.Adodc3.RecordSource = "SELECT * FROM ozanmasir WHERE name= '«” —‰œ— 36 + 1' "
...
If Form15.Adodc3.Recordset.RecordCount > 0 Then
  ...
  Do
    ...
    Adodc3.RecordSource = "select * from Sterander1_36 WHERE (idmahsol=" + Trim(Str(Form15.Adodc3.Recordset.Fields!idmahsol)) + ") and (rad=" + Trim(Str(Form15.Adodc3.Recordset.Fields!rad)) + ")"
    Adodc3.Refresh
    ...
    If Adodc4.Recordset.RecordCount > 0 Then
      Adodc4.Recordset.Find "name= '«” —‰œ— 36 + 1'"
      ...
      If Adodc4.Recordset.BOF = False Then
        Select Case Adodc4.Recordset.Fields!Name
          ...
          Case "«ò” —Êœ—"
            Form20.Adodc3.RecordSource = "SELECT * From Exteroder WHERE (idmahsol=" + Trim(Str(Adodc4.Recordset.Fields!idmahsol)) + ") and (rad=" + Trim(Str(Adodc4.Recordset.Fields!rad)) + ")"
            Form20.Adodc3.Refresh
            If Form20.Adodc3.Recordset.RecordCount > 0 Then
              q = Val(q) + Val(Form20.Adodc3.Recordset.Fields!naghlbebadmeghdar)
              w = Val(w) + Val(Form20.Adodc3.Recordset.Fields!naghlbebadmoney)
            End If
...
Adodc3.ConnectionString = Form3.Text10.Text
Adodc3.CommandType = adCmdUnknown
Adodc3.RecordSource = "select * from Sterander1_36 ORDER BY rad ASC"
Adodc3.Refresh
